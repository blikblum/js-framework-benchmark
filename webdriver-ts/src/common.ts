...
export let frameworks = [
    ...
    f("marionette-next-v3.3.1", false),
    f("marionette-notrigger-v3.3.1", false),
    f("marionette-zepto-v3.3.1", false),
    f("marionette-native-v3.3.1", false),
    f("marionette-rivets-v3.3.1", false),
    f("marionette-snabbdom-v3.3.1", false),
    f("marionette-snabbdom-full-v3.3.1", false),
    f("marionette-hyperscript-v3.3.1", false),
    f("marionette-virtual-dom-v3.3.1", false),
    f("marionette-idom-v3.3.1", false),

...
const canViewRenderer = function (template, data) {
  if (this.isRendered()) this.$el.empty()
  var children = template.hydrate(data)
...
ChildView.setRenderer(canViewRenderer)
